...
namespace CoreWCF.Xml
{
    ...
    {
        // from XmlDictionaryString
        private const int MinKey = 0;
        private const int MaxKey = int.MaxValue / 4;
        ...
        {
            ThrowXmlException(reader, SR.XmlDictionaryStringIDRange, MinKey.ToString(NumberFormatInfo.CurrentInfo), MaxKey.ToString(NumberFormatInfo.CurrentInfo));
        }
