    ...
    internal abstract class XmlBaseWriter : XmlDictionaryWriter
    {
        ...
        public override void WriteXmlnsAttribute(string? prefix, string ns)
        {
            ...
            if (_writeState != WriteState.Element)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(SR.Format(SR.XmlInvalidWriteState, "WriteXmlnsAttribute", WriteState.ToString())));
        ...
        private void StartAttribute([AllowNull] ref string prefix, string localName, string? ns, XmlDictionaryString? xNs)
        {
            ...
            if (_writeState != WriteState.Element)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(SR.Format(SR.XmlInvalidWriteState, "WriteStartAttribute", WriteState.ToString())));
            ...
            if (prefix == "xml")
            {
                if (ns != null && ns != xmlNamespace)
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(SR.Format(SR.XmlPrefixBoundToNamespace, "xml", xmlNamespace, ns), nameof(ns)));
            ...
            else if (prefix == "xmlns")
            {
                if (ns != null && ns != xmlnsNamespace)
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(SR.Format(SR.XmlPrefixBoundToNamespace, "xmlns", xmlnsNamespace, ns), nameof(ns)));
            ...
            else if (ns.Length == 0)
            {
                ...
                if (prefix.Length != 0)
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(SR.XmlEmptyNamespaceRequiresNullPrefix, nameof(prefix)));
            }
            else if (prefix.Length == 0)
            {
                ...
                if (tempPrefix == null)
                {
                    ...
                    if (ns.Length == xmlnsNamespace.Length && ns == xmlnsNamespace)
                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(SR.Format(SR.XmlSpecificBindingNamespace, "xmlns", ns)));
                    if (ns.Length == xmlNamespace.Length && ns == xmlNamespace)
                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(SR.Format(SR.XmlSpecificBindingNamespace, "xml", ns)));
        ...
        public override void WriteComment(string? text)
        {
            ...
            if (_writeState == WriteState.Attribute)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(SR.Format(SR.XmlInvalidWriteState, "WriteComment", WriteState.ToString())));
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(SR.XmlInvalidCommentChars, nameof(text)));
            }
        ...
        public override void WriteFullEndElement()
        {
            ...
            if (_writeState != WriteState.Element && _writeState != WriteState.Content)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(SR.Format(SR.XmlInvalidWriteState, "WriteFullEndElement", WriteState.ToString())));
        ...
        public override void WriteCData(string? text)
        {
            ...
            if (_writeState == WriteState.Attribute)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(SR.Format(SR.XmlInvalidWriteState, "WriteCData", WriteState.ToString())));
        ...
        {
            throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new NotSupportedException(SR.Format(SR.XmlMethodNotSupported, "WriteDocType")));
        }
        ...
        private string GetQualifiedNamePrefix(string namespaceUri, XmlDictionaryString? xNs)
        {
            ...
            {
                if (_writeState != WriteState.Attribute)
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(SR.Format(SR.XmlNamespaceNotFound, namespaceUri), nameof(namespaceUri)));
        ...
        public override void WriteStartDocument()
        {
            ...
            if (_writeState != WriteState.Start)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(SR.Format(SR.XmlInvalidWriteState, "WriteStartDocument", WriteState.ToString())));
        ...
        public override void WriteProcessingInstruction(string name, string? text)
        {
            ...
            if (name != "xml")
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(SR.XmlProcessingInstructionNotSupported, nameof(name)));
        ...
        {
            throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new NotSupportedException(SR.Format(SR.XmlMethodNotSupported, "WriteEntityRef")));
        }
        ...
        {
            throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new NotSupportedException(SR.Format(SR.XmlMethodNotSupported, "WriteNmToken")));
        }
        ...
        public override void WriteWhitespace(string? whitespace)
        {
            ...
            if (whitespace == null)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperArgumentNull(nameof(whitespace));
            ...
            for (int i = 0; i < whitespace.Length; ++i)
            {
                ...
                if (c != ' ' &&
                    ...
                    c != '\n' &&
                    c != '\r')
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(SR.XmlOnlyWhitespace, nameof(whitespace)));
            }
        ...
        public override void WriteCharEntity(char ch)
        {
            ...
            if (ch >= 0xd800 && ch <= 0xdfff)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(SR.XmlMissingLowSurrogate, nameof(ch)));
        ...
        protected void WritePrimitiveValue(object value)
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(SR.XmlNestedArraysNotSupported, nameof(value)));
            }
            else
            {
        ...
        private string GeneratePrefix(string ns, XmlDictionaryString? xNs)
        {
            if (_writeState != WriteState.Element && _writeState != WriteState.Attribute)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(SR.Format(SR.XmlInvalidPrefixState, WriteState.ToString())));
        ...
        private sealed class NamespaceManager
        {
            ...
            public void AddNamespace(string prefix, string uri, XmlDictionaryString? uriDictionaryString)
            {
                if (prefix.Length >= 3)
                {
                    ...
                    if ((prefix[0] & ~32) == 'X' && (prefix[1] & ~32) == 'M' && (prefix[2] & ~32) == 'L')
                    {
                        ...
                        if (prefix == "xmlns" && uri == xmlnsNamespace)
                            return;
                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(SR.XmlReservedPrefix, nameof(prefix)));
                    }
                }
                Namespace nameSpace;
                for (int i = _nsCount - 1; i >= 0; i--)
                {
                    ...
                    if (nameSpace.Prefix == prefix)
                    {
                        if (nameSpace.Uri == uri)
                            return;
                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(SR.Format(SR.XmlPrefixBoundToNamespace, prefix, nameSpace.Uri, uri), nameof(prefix)));
                    }
                }
                if (prefix.Length != 0 && uri.Length == 0)
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(SR.XmlEmptyNamespaceRequiresNullPrefix, nameof(prefix)));
                if (uri.Length == xmlnsNamespace.Length && uri == xmlnsNamespace)
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(SR.Format(SR.XmlSpecificBindingNamespace, "xmlns", uri)));
                ...
                if (uri.Length == xmlNamespace.Length && uri[18] == 'X' && uri == xmlNamespace)
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(SR.Format(SR.XmlSpecificBindingNamespace, "xml", uri)));
